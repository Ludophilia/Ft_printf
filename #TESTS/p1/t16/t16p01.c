...
/*   Updated: 2024/12/21 17:47:32 by jegerman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	test_u_bonus_flags_return_values_t1(void)
{
	...
	ret = ft_printf(format, 0, 0, -10, -10, -42, -42, 0, 42);
	if (DEBUG
		&& dprintf(2, "printf(\"%s\", ...) -> %i\n", format, ret))
		;
	return (1);
...
int	test_u_bonus_flags_return_values_t2(void)
{
	...
	ret = ft_printf(format, 0, 10, -10, -10, -10, 10);
	if (DEBUG
		&& dprintf(2, "printf(\"%s\", ...) -> %i\n", format, ret))
		;
	return (1);
...
int	test_u_bonus_flags_return_values_t4(void)
{
	...
	ret = ft_printf(format, 0, 10, 0, 10, -10, -10, 10);
	if (DEBUG
		&& dprintf(2, "printf(\"%s\", ...) -> %i\n", format, ret))
		;
	return (1);
