...
#include "printf_examples.h"

void	format_string(int do_it)
{
	if (!do_it)
		return ;
	printf("\x1b[36mJust format string, no specifiers and flags:\x1b[0m\n");
...
void	character_specifier(int do_it)
{
	if (!do_it)
		return ;
	printf("\x1b[36mCharacter specifiers and flags:\x1b[0m\n");
	printf("%s'%c'\n", 
...
void	string_specifier(int do_it)
{
	if (!do_it)
		return ;
	printf("\x1b[36mString specifier and flags:\x1b[0m\n");
	printf("%s'%s'%s''\n",
...
void	integer_specifier(int do_it)
{
	if (!do_it)
		return ;
	printf("\x1b[36mInteger specifiers and flags:\x1b[0m\n");
	printf("%s'%i,%d'\n",
...
void	hexadecimal_specifier(int do_it)
{
	if (!do_it)
		return ;
	printf("\x1b[36mHexadecimal specifier and flags:\x1b[0m\n");
...
void	pointer_specifier(int do_it)
{
	...
	if (!do_it)
		return ;
	printf("\x1b[36mPointers specifier and flags:\x1b[0m\n");
	printf("%s'%p'\n",
...
void	just_pourcent(int do_it)
{
	if (!do_it)
		return ;
	printf("\x1b[36mJust Pourcent:\x1b[0m\n");
	printf("%s'42%%'\n",
		"\tJust pourcent:\n\t\x20");
}
